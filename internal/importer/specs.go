...
var divisionsSpec = EntitySpec{
	...
	Columns: []ColumnSpec{
		...
		{Key: "division_type", Type: TypeString,
			Description: "Tipe divisi: internal (di bawah Wakil Ketua Internal), external (di bawah Wakil Ketua External), atau core (Pengurus Inti/BPH — tampil di puncak struktur organisasi). Kosong dianggap internal.",
