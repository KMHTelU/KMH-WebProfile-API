...
-- ── Hall of Fame (arsip sejarah untuk museum 3D) ──
-- Terpisah dari tabel operasional (members/divisions) karena karakter datanya
-- berbeda: biografi, kontribusi, legacy, dan kutipan terverifikasi per era.
